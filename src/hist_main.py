...
from hist_rag_chain import create_rag_chain
...
# Create retriever and chain (only once)
...
with col2:
    ...
    if st.button("New Chat", type="primary", use_container_width=True):
        # Clear the memory object directly
        ...
        with st.spinner("Fetching answer..."):
            try:
                result = st.session_state.rag_chain.invoke({
                    "question": prompt,
                    "chat_history": []  # This is ignored, memory handles it
                })
